...
const PageLayout: React.FC<PageLayoutProps> = ({
  ...
  return (
    <main className="relative flex items-center justify-center p-2 md:p-3 lg:p-4 pt-1 pb-4 bg-white mt-12 md:mt-16">
      <div className="w-full max-w-7xl">
        ...
        >
          ...
          <div className="relative py-1 px-2 lg:px-3 bg-white">
            <div className="relative z-10">
              {/* Header Section */}
              {(title || subtitle) && (
                <section className="text-center py-1 md:py-2 lg:py-3 px-4 md:px-6">
