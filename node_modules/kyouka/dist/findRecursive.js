 ...
 * @returns
 */
function findRecursive(data, targetKey, condition) {
    ...
    if (data && typeof data === "object") {
        ...
        for (const key in data) {
            if (key !== targetKey &&
                ...
                const result = findRecursive(data[key], targetKey, condition);
                if (result)
                    return result;
            }
        }
 ...
 * @returns
 */
function findAllRecursive(data, targetKey, condition) {
    const results = [];
